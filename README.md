...
```javascript
import isConstantcase from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-constantcase@v0.2.3-esm/index.mjs';
```
...
[@stdlib/assert/is-camelcase]: https://github.com/stdlib-js/assert-is-camelcase/tree/esm
